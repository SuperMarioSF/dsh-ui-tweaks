...
.dsh-ui-subagent-label{max-width:220px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;vertical-align:bottom}
...
.dsh-ui-request-subagent-detail{padding:8px;border-top:1px solid var(--dsw-alias-border-l1)}
.dsh-ui-subagent-box{max-width:100%;overflow-x:auto}
			...
			const renderSubagentBlock = (node) => {
				...
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement("span", { className: "dsh-ui-subagent-item-name", title: node.id }, node.label),
			...
			const renderSubagentRow = (node) => {
				...
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement("td", null, new Date(node.createdAt ?? node.requests?.[0]?.startedAt ?? Date.now()).toLocaleString("zh-CN", { year: "numeric", month: "2-digit", day: "2-digit", hour: "2-digit", minute: "2-digit", second: "2-digit", hour12: false })),
						React.createElement("td", null,
							React.createElement(
								"button",
								{ type: "button", className: "dsh-ui-subagent-toggle", onClick: () => toggleSubagent(node.id) },
							...
							React.createElement(
								...
								detailEntries.map((entry) => entry.kind === "subagent"
									...
									: React.createElement(
										"tr",
										{ key: entry.row.key },
										React.createElement("td", null, new Date(entry.row.time).toLocaleString("zh-CN", { year: "numeric", month: "2-digit", day: "2-digit", hour: "2-digit", minute: "2-digit", second: "2-digit", hour12: false })),
