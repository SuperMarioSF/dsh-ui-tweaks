...
.dsh-ui-balance-popup{position:absolute;top:calc(100% + 8px);right:0;z-index:100;box-sizing:border-box;width:720px;max-width:96vw;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-specific-menu,var(--dsw-alias-bg-layer-2));box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-primary);border-radius:12px;padding:12px;font-size:12px;line-height:18px}
...
.dsh-ui-request-table th,.dsh-ui-request-table td{text-align:right;padding:2px 3px;white-space:nowrap;font-size:10px;line-height:14px;border-bottom:1px solid var(--dsw-alias-border-l1)}
...
.dsh-ui-request-section > .dsh-ui-request-table th{position:sticky;top:0;z-index:1;color:var(--dsw-alias-label-caption);font-weight:400;background:var(--dsw-alias-bg-layer-1)}
.dsh-ui-request-table tbody tr:hover{background:var(--dsw-alias-interactive-bg-hover)}
.dsh-ui-request-table th:first-child,.dsh-ui-request-table td:first-child{width:16%}
.dsh-ui-request-table th:nth-child(2),.dsh-ui-request-table td:nth-child(2){width:24%;overflow:hidden;text-overflow:ellipsis}
.dsh-ui-request-table th:nth-child(3),.dsh-ui-request-table td:nth-child(3){width:8%}
.dsh-ui-request-table th:nth-child(4),.dsh-ui-request-table td:nth-child(4),.dsh-ui-request-table th:nth-child(5),.dsh-ui-request-table td:nth-child(5),.dsh-ui-request-table th:nth-child(6),.dsh-ui-request-table td:nth-child(6){width:12%}
.dsh-ui-request-table th:last-child,.dsh-ui-request-table td:last-child{width:12%}
...
.dsh-ui-subagent-cell-inner{display:flex;align-items:center;justify-content:space-between;gap:8px;min-width:0;width:100%}
.dsh-ui-subagent-title{flex:1;min-width:0;display:flex;align-items:center;justify-content:flex-end;gap:4px;text-align:right;overflow:hidden}
.dsh-ui-subagent-prefix{font-size:10px;line-height:14px;color:var(--dsw-alias-label-tertiary);flex:none}
.dsh-ui-subagent-label{max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;vertical-align:bottom}
.dsh-ui-request-subagent-row td{background:var(--dsw-alias-bg-layer-1)}
.dsh-ui-request-subagent-row.dsh-ui-sticky-active{position:sticky;top:0;z-index:4}
.dsh-ui-request-subagent-detail-row td{padding:0 3px!important;border-bottom:0!important;background:var(--dsw-alias-bg-layer-1)}
.dsh-ui-request-subagent-detail{padding:8px 0;border-top:1px solid var(--dsw-alias-border-l1);max-width:100%;box-sizing:border-box}
.dsh-ui-request-subagent-cost{text-align:right!important}
.dsh-ui-subagent-box{width:100%;max-width:100%;box-sizing:border-box;margin:0;padding:0}
.dsh-ui-subagent-item{border-radius:6px;background:var(--dsw-alias-bg-layer-1);margin:0;padding:0}
.dsh-ui-subagent-item.dsh-ui-sticky-active{position:sticky;z-index:2}
.dsh-ui-subagent-item-header{display:flex;align-items:center;gap:8px;padding:4px 0;border-radius:6px;background:var(--dsw-alias-bg-layer-1);margin:0}
...
.dsh-ui-subagent-detail{padding:0}
.dsh-ui-subagent-children{margin:4px 0 0;padding:0;border:0}
...
.dsh-ui-subagent-request-table{width:100%;max-width:100%;table-layout:fixed;margin:6px 0 4px}
.dsh-ui-subagent-request-table th,.dsh-ui-subagent-request-table td{padding-left:0;padding-right:0}
.dsh-ui-subagent-request-table th:first-child,.dsh-ui-subagent-request-table td:first-child{width:16%}
.dsh-ui-subagent-request-table th:nth-child(2),.dsh-ui-subagent-request-table td:nth-child(2){width:24%;overflow:hidden;text-overflow:ellipsis}
.dsh-ui-subagent-request-table th:nth-child(3),.dsh-ui-subagent-request-table td:nth-child(3){width:8%}
.dsh-ui-subagent-request-table th:nth-child(4),.dsh-ui-subagent-request-table td:nth-child(4),.dsh-ui-subagent-request-table th:nth-child(5),.dsh-ui-subagent-request-table td:nth-child(5),.dsh-ui-subagent-request-table th:nth-child(6),.dsh-ui-subagent-request-table td:nth-child(6){width:12%}
.dsh-ui-subagent-request-table th:last-child,.dsh-ui-subagent-request-table td:last-child{width:12%}
.dsh-ui-subagent-request-table thead.dsh-ui-sticky-active th{position:sticky;top:var(--dsh-ui-subagent-sticky-top, 22px);z-index:2;background:var(--dsw-alias-bg-layer-1)}
.dsh-ui-subagent-nested-table{width:100%;max-width:100%;table-layout:fixed;margin:0;padding:0}
.dsh-ui-subagent-nested-table .dsh-ui-subagent-nested-table{width:calc(100% + 6px);max-width:calc(100% + 6px);margin-left:-3px;margin-right:-3px}
.dsh-ui-subagent-nested-table th{text-align:left;background:var(--dsw-alias-bg-layer-1);padding-left:0;padding-right:0}
.dsh-ui-subagent-nested-detail{padding:0!important;margin:0}
...
`;
		...
		// 2026-08-21 00:00 Beijing = 2026-08-20 16:00 UTC
		const VISION_PRICING_EFFECTIVE_AT = Date.UTC(2026, 7, 20, 16, 0, 0);
		...
		const PRICING_SCHEDULES = [
			...
			{
				effectiveAt: VISION_PRICING_EFFECTIVE_AT,
				peakWindows: [{ start: 9, end: 12 }, { start: 14, end: 18 }],
				prices: {
					...PRICING,
		...
		function priceFor(model, timestamp, period) {
			...
			for (let i = PRICING_SCHEDULES.length - 1; i >= 0; i--) {
				const entry = PRICING_SCHEDULES[i];
		...
		function normalizeModel(model) {
			...
			if (value.includes("deepseek-v4-flash-vision") || value.includes("v4-flash-vision")) return "deepseek-v4-flash-vision-exp";
		...
		function computeRequestUsage(requests) {
			...
			for (const request of requests) {
				...
				rows.push({
					key: `${request.subagentId ? `sub:${request.subagentId}:` : "main:"}${request.startSeq ?? `idx:${rows.length}`}`,
		...
		function historyEventsToRequests(events, headerEpochs) {
			...
			const assistantStartSeqs = new Map();
			const assistantUsageByStep = new Map();
			const compactionStartSeqs = new Map();
			for (const event of events) {
				if (event.type === "request/header") {
					...
					if (key !== "undefined:undefined") {
						if (!assistantStartSeqs.has(key)) assistantStartSeqs.set(key, event.seq);
						const chunkUsage = event.data?.chunk?.usage;
						if (chunkUsage) assistantUsageByStep.set(key, addTokenUsage(assistantUsageByStep.get(key), chunkUsage));
					}
				} else if (event.type === "assistant/message") {
					const key = `${event.data?.turn}:${event.data?.step}`;
					const usage = event.data?.usage ?? assistantUsageByStep.get(key);
					if (!usage) continue;
					...
					requests.push({
						startSeq: assistantStartSeqs.get(key) ?? event.seq,
						startedAt: event.time,
						completedAt: event.time,
						requestKey: `assistant:${event.data?.turn}:${event.data?.step}`,
					...
					if (compactionId != null) compactionStartSeqs.set(compactionId, { seq: event.seq, turn: event.data?.turn });
				} else if (event.type === "compaction/summary") {
					const usage = event.data?.usage;
					if (!usage) continue;
					const provider = event.data?.provider;
					const model = event.data?.model;
					const startInfo = compactionStartSeqs.get(event.data?.compactionId);
					const startSeq = startInfo?.seq ?? event.seq;
					const turn = startInfo?.turn;
					requests.push({
						startSeq,
						startedAt: event.time,
						completedAt: event.time,
						requestKey: turn != null ? `compaction:${turn}:0` : `compaction:${startSeq}`,
						provenance: provider !== void 0 || model !== void 0 ? { provider, model } : undefined,
		...
		const SUBAGENT_STICKY_HEADER_H = 22;

		function clearSubagentSticky(container) {
			if (!container) return;
			for (const el of container.querySelectorAll(".dsh-ui-sticky-active")) {
				el.classList.remove("dsh-ui-sticky-active");
				el.style.top = "";
				el.style.removeProperty("--dsh-ui-subagent-sticky-top");
			}
		}

		function activateSubagentHeader(detail, top) {
			const thead = detail.querySelector("thead.dsh-ui-subagent-sticky-header");
			if (thead) {
				thead.classList.add("dsh-ui-sticky-active");
				thead.style.setProperty("--dsh-ui-subagent-sticky-top", `${top}px`);
			}
		}

		function activateNestedSubagentSticky(childrenContainer, aggregateTop, containerTop) {
			if (!childrenContainer) return;
			const items = Array.from(childrenContainer.children).filter((el) => el.classList.contains("dsh-ui-subagent-item"));
			for (const item of items) {
				const detail = item.querySelector(":scope > .dsh-ui-subagent-nested-table > tbody > tr > td.dsh-ui-subagent-nested-detail");
				if (!detail) continue;
				const itemRect = item.getBoundingClientRect();
				const detailRect = detail.getBoundingClientRect();
				if (itemRect.top <= containerTop + aggregateTop && detailRect.bottom > containerTop + aggregateTop + SUBAGENT_STICKY_HEADER_H) {
					const parentDetail = childrenContainer.closest("td.dsh-ui-subagent-nested-detail");
					const parentHeader = parentDetail?.querySelector("thead.dsh-ui-subagent-sticky-header");
					if (parentHeader) {
						parentHeader.classList.remove("dsh-ui-sticky-active");
						parentHeader.style.removeProperty("--dsh-ui-subagent-sticky-top");
					}
					const aggregateHeader = item.querySelector(":scope > .dsh-ui-subagent-nested-table > thead.dsh-ui-subagent-sticky-header");
					if (aggregateHeader) {
						aggregateHeader.classList.add("dsh-ui-sticky-active");
						aggregateHeader.style.setProperty("--dsh-ui-subagent-sticky-top", `${aggregateTop}px`);
					}
					activateSubagentHeader(detail, aggregateTop + SUBAGENT_STICKY_HEADER_H);
					const childContainer = detail.querySelector(":scope > .dsh-ui-subagent-children");
					activateNestedSubagentSticky(childContainer, aggregateTop + SUBAGENT_STICKY_HEADER_H, containerTop);
					return;
				}
			}
		}

		function updateSubagentSticky(container) {
			if (!container) return;
			clearSubagentSticky(container);
			const table = container.querySelector("table.dsh-ui-request-table");
			if (!table) return;
			const rows = Array.from(table.querySelectorAll(":scope > tbody > tr.dsh-ui-request-subagent-row"));
			const containerTop = container.getBoundingClientRect().top;
			for (const row of rows) {
				const detail = row.nextElementSibling;
				if (!detail || !detail.classList.contains("dsh-ui-request-subagent-detail-row")) continue;
				const rowRect = row.getBoundingClientRect();
				const detailRect = detail.getBoundingClientRect();
				if (rowRect.top <= containerTop && detailRect.bottom > containerTop + SUBAGENT_STICKY_HEADER_H) {
					row.classList.add("dsh-ui-sticky-active");
					activateSubagentHeader(detail, SUBAGENT_STICKY_HEADER_H);
					const childrenContainer = detail.querySelector(".dsh-ui-subagent-children");
					activateNestedSubagentSticky(childrenContainer, SUBAGENT_STICKY_HEADER_H, containerTop);
					return;
				}
			}
		}

		function requestKeyOf(request) {
			if (request.subagentId) return `sub:${request.subagentId}:${request.turn ?? ""}:${request.step ?? ""}`;
			if (request.purpose === "compaction") {
				const turn = request.turn;
				return turn != null ? `compaction:${turn}:0` : `compaction:${request.startSeq ?? ""}`;
			}
			return `assistant:${request.turn ?? ""}:${request.step ?? ""}`;
		}
		...
		function BalanceBadge({ sessionId, useSession }) {
			...
			const [historyState, setHistoryState] = React.useState({ status: "loading", rows: [], lastSeq: 0, seenKeys: [], incomplete: true });
			...
			React.useEffect(() => {
				let cancelled = false;
				setHistoryState({ status: "loading", rows: [], lastSeq: 0, seenKeys: [], incomplete: true });
				...
				fetchAllSessionHistory(sessionId)
					.then(({ events, incomplete, headerEpochs }) => {
						...
						const historyKeys = historyRequests.map((request) => request.requestKey ?? String(request.startSeq ?? 0));
						seenKeysRef.current = new Set(historyKeys);
						console.log("[dsh-ui-tweaks] history ready " + JSON.stringify({
						...
						setHistoryState({
							...
							rows: computeSessionUsage(historyRequests),
							lastSeq,
							seenKeys: historyKeys,
							incomplete
						});
					})
					.catch(() => {
						if (!cancelled) setHistoryState({ status: "error", rows: [], lastSeq: 0, seenKeys: [], incomplete: true });
					});
				return () => {
					cancelled = true;
				};
			...
			React.useEffect(() => {
				...
				for (const request of requests ?? []) {
					...
					if (seen.has(key) || seenInBatch.has(key)) continue;
					if (usageOfRequest(request) === null) continue;
					seen.add(key);
					seenInBatch.add(key);
				...
				console.log("[dsh-ui-tweaks] diff " + JSON.stringify({
					requests: newRequests.map((r) => ({ key: requestKeyOf(r), seq: r.startSeq, usage: r.usage })),
					rows: newRows
				}));
				setHistoryState((prev) => ({
					...
					seenKeys: [...prev.seenKeys, ...newRequests.map((request) => requestKeyOf(request))]
				}));
				setDetailRows((prev) => mergeRequestRows(prev, newDetails));
			}, [requests, historyState.status, historyState.seenKeys, historyState.lastSeq]);
			...
			const toggleSubagent = (id) => {
				...
				setTimeout(() => {
					const section = rootRef.current?.querySelector(".dsh-ui-request-section");
					if (section) updateSubagentSticky(section);
				}, 0);
			};
			...
			const renderRequestRowsTable = (rows) => React.createElement(
				"table",
				{ className: "dsh-ui-request-table dsh-ui-subagent-request-table" },
				React.createElement(
					"thead",
					{ className: "dsh-ui-subagent-sticky-header" },
					React.createElement(
						"tr",
						null,
				...
				React.createElement(
					...
					rows.map((row) => React.createElement(
						"tr",
						{ key: row.key },
						React.createElement("td", null, formatTime(row.time)),
						React.createElement("td", null, row.purpose === "compaction" ? `(压缩) ${row.model}` : row.model),
						React.createElement("td", null, row.period === "peak" ? React.createElement("span", { className: "dsh-ui-peak" }, "高峰") : React.createElement("span", { className: "dsh-ui-offpeak" }, "闲时")),
						React.createElement("td", null,
							React.createElement("div", null, formatTokens(row.cacheInput)),
							React.createElement("div", { className: "dsh-ui-usage-subcost" }, formatCost(row.cacheCost))
			...
			const renderSubagentBlock = (node) => {
				...
				return React.createElement(
					...
					React.createElement(
						"table",
						{ className: "dsh-ui-request-table dsh-ui-subagent-request-table dsh-ui-subagent-nested-table" },
						React.createElement(
							"thead",
							{ className: "dsh-ui-subagent-sticky-header" },
							React.createElement(
								...
								React.createElement(
									"th",
									{ colSpan: 7, className: "dsh-ui-subagent-aggregate-cell" },
									React.createElement(
										"div",
						...
						expanded && React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									"td",
									{ colSpan: 7, className: "dsh-ui-subagent-nested-detail" },
									(node.requests?.length ?? 0) > 0 && renderRequestRowsTable(computeRequestUsage(node.requests ?? [])),
			...
			const renderSubagentRow = (node) => {
				...
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement("td", { colSpan: 5, className: "dsh-ui-subagent-main" },
							React.createElement(
								"div",
						...
						React.createElement("td", { className: "dsh-ui-request-subagent-cost" }, formatCost(totals.cost))
					),
					expanded && React.createElement(
						"tr",
			...
			React.useEffect(() => {
				if (!open || !showRequests) return;
				const section = rootRef.current?.querySelector(".dsh-ui-request-section");
				if (section) updateSubagentSticky(section);
			}, [open, showRequests, subagentTree]);
