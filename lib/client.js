...
.dsh-ui-subagent-box{width:100%;max-width:100%;box-sizing:border-box}
.dsh-ui-subagent-item{border-radius:6px;background:var(--dsw-alias-bg-layer-1)}
.dsh-ui-subagent-item.dsh-ui-sticky-active{position:sticky;z-index:2}
.dsh-ui-subagent-item-header{display:flex;align-items:center;gap:8px;padding:4px 6px;border-radius:6px;background:var(--dsw-alias-bg-layer-1)}
...
.dsh-ui-subagent-children{margin-top:4px;padding-left:0;border-left:0}
...
.dsh-ui-subagent-nested-table{width:100%;table-layout:fixed;margin:0}
.dsh-ui-subagent-nested-table th{text-align:left;background:var(--dsw-alias-bg-layer-1)}
.dsh-ui-subagent-nested-detail{padding:0!important}
