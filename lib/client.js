...
.dsh-ui-subagent-box{padding:8px;border-top:1px solid var(--dsw-alias-border-l1);max-width:100%;overflow-x:auto}
.dsh-ui-subagent-item{display:block;border-radius:6px}
...
.dsh-ui-subagent-table{width:100%;margin:6px 0 4px;background:var(--dsw-alias-bg-layer-2);border-radius:8px}
											...
											subagentState.subagents.map((subagent) => React.createElement(
												...
												React.createElement(
													...
													React.createElement(
														...
														expandedSubagentIds.has(subagent.id) ? "⮝" : "⮟"
													),
