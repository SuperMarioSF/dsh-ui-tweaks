...
.dsh-ui-subagent-request-table th:first-child,.dsh-ui-subagent-request-table td:first-child{width:90px;overflow:hidden;text-overflow:ellipsis}
.dsh-ui-subagent-request-table th:nth-child(2),.dsh-ui-subagent-request-table td:nth-child(2){width:110px;overflow:hidden;text-overflow:ellipsis}
.dsh-ui-subagent-request-table th:nth-child(3),.dsh-ui-subagent-request-table td:nth-child(3){width:36px}
.dsh-ui-subagent-request-table th:nth-child(4),.dsh-ui-subagent-request-table td:nth-child(4),.dsh-ui-subagent-request-table th:nth-child(5),.dsh-ui-subagent-request-table td:nth-child(5),.dsh-ui-subagent-request-table th:nth-child(6),.dsh-ui-subagent-request-table td:nth-child(6){width:50px}
.dsh-ui-subagent-request-table th:last-child,.dsh-ui-subagent-request-table td:last-child{width:54px}
