...
.dsh-ui-request-table th:first-child,.dsh-ui-request-table td:first-child{width:16%;overflow:hidden;text-overflow:ellipsis}
...
.dsh-ui-request-subagent-detail-row td{padding:0 8px!important;border-bottom:0!important;background:var(--dsw-alias-bg-layer-1)}
...
.dsh-ui-subagent-request-table th:first-child,.dsh-ui-subagent-request-table td:first-child{width:16%;overflow:hidden;text-overflow:ellipsis}
