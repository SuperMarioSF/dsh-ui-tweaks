...
.dsh-ui-request-subagent-row{position:sticky;top:0;z-index:4}
.dsh-ui-request-subagent-row td{background:var(--dsw-alias-bg-layer-1)}
.dsh-ui-request-subagent-detail-row{position:sticky;top:22px;z-index:3}
...
.dsh-ui-subagent-item{position:sticky;top:44px;z-index:2;border-radius:6px;background:var(--dsw-alias-bg-layer-1)}
