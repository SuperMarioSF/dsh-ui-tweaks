...
.dsh-ui-request-table th:first-child,.dsh-ui-request-table td:first-child{width:110px;overflow:hidden;text-overflow:ellipsis}
.dsh-ui-request-table th:nth-child(2),.dsh-ui-request-table td:nth-child(2){width:150px;overflow:hidden;text-overflow:ellipsis}
.dsh-ui-request-table th:nth-child(3),.dsh-ui-request-table td:nth-child(3){width:44px}
.dsh-ui-request-table th:nth-child(4),.dsh-ui-request-table td:nth-child(4),.dsh-ui-request-table th:nth-child(5),.dsh-ui-request-table td:nth-child(5),.dsh-ui-request-table th:nth-child(6),.dsh-ui-request-table td:nth-child(6){width:70px}
.dsh-ui-request-table th:last-child,.dsh-ui-request-table td:last-child{width:64px}
.dsh-ui-request-table{table-layout:fixed}
.dsh-ui-subagent-toggle{min-width:26px;height:26px;flex:none;display:inline-flex;align-items:center;justify-content:center;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;padding:0;font-size:14px;white-space:nowrap}
...
.dsh-ui-subagent-table th:first-child,.dsh-ui-subagent-table td:first-child{width:140px;overflow:hidden;text-overflow:ellipsis}
.dsh-ui-subagent-table th:nth-child(2),.dsh-ui-subagent-table td:nth-child(2){width:44px}
				...
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement("span", { className: "dsh-ui-subagent-prefix" }, "子代理 "),
